...
const ParkingPlace = () => {
    ...
    return (
       <>
       <Header/>
            <div className="container mt-5 bg-light mb-5">
                    ...
                    {locations.map((location) => (
                        <div className="col-md-4 mb-4" key={location.id}>
                            <div className="card h-100 shadow">
                                <img src={location.image} className="card-img-top h-300" alt={location.name} />
                                <div className="card-body">
                                    <h5 className="card-title">{location.name}</h5>
    
                                    <a href="" target="_blank" className="btn btn-danger shadow">
                                        Book Slot
                                    </a>
                                </div>
                            </div>
